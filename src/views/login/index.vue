  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <div class="title-container">
        <h3 class="title">
          <img src="@/assets/common/login-logo.jpg" alt="">
        </h3>
      </div>
  ...
  data() {
    ...
    return {
      ...
      loginRules: {
        ...
        password: [{ required: true, trigger: 'blur', message: '密码不能为空' }, { trigger: 'blur', min: 6, max: 16, message: '密码为6-16位之间' }]
      },
      loading: false,
